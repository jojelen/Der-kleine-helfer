...
parser.add_argument("-r", "--random", action="store_true",
                    help="Sends it immediately without asking.")
...
def choose_recipes(num):
    ...
    while True:
        ...
        print("\n{} random {} from Der kleine helfer:".format(num, "recipes" if
                                                              num > 1 else "recipe"))
...
def main():
    ...
    if args.verbose:
        print("Running Der kleine Helfer with verbose=true, count={}".format(args.count))
